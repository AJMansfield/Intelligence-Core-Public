...
Once they had managed to secure a hard mechanical connection &mdash; assuming they were able to, and weren't forced to abort &mdash;
  they would assess the condition of Carina's docking hatch to determine whether and how to open it safely,
  and if possible they would use a robotic vehicle to enter the craft, and retrieve Carina's flight manuals.
...
"Standby to confirm capture," the mission conductor declared,
  ...
  on whether to proceed with the docking attempt.

"Vehicle Controller"  &mdash; "Go."
...
These were the two surveillence sattelites that had been moved into orbits near Carina nearly from the beginning of the program,
...
There was a brief pause,
  and then a rapid series of clacks resonated through the craft and over Angela's headset
  as the docking latches retracted,
