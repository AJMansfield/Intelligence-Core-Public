...
All things considered,
  you've done a remarkable job getting a handle on the most-commonly-used pidgin language and some key local vocabulary.
...
You really need to start growing some of your own Earth vegetables.
While you're able to get enough calories, you have no idea whether these foods contain all the nutrients _you_ need,
  and your vitamin tablets are going to last you only so long.
