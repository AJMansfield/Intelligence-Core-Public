...
Someone fairly high up had made a connection between the recent
  "SigilTek" startup and the Americans' efforts to reach Carina,
  and that the supposed "new technology" was likely not new at all,
  but rather something they'd found and reverse-engineered.
While SigilTek hadn't released any actual products yet,
  the thinking was that when they _did_,
  the opportunity to produce their own knockoff clones would be too lucrative to disregard.

Solomon wasn't entirely convinced by their line of reasoning,
  but he wasn't going to look this gift horse in the mouth.
Even ignoring the intricacies of international IP law,
...
Really, it just had to add enough uncertainty to the case
  to allow them to negotate a more favorable royalty rate as part of the settlement.
