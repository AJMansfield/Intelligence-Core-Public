...
While for small trees the procedure _was_ doable by hand,
  the complexity could quickly baloon as you added more primitives,
...
Now that there was enough space to grab onto the panel's edge,
  ...
  before slowly swinging the suprisingly-heavy panel down.
...
At this point, Joyce passed Jack the camera she'd been using to film all this,
  and he carefully shined some light into the opening to get a proper view of what was going on.
...
Perhaps whatever technology they used was simply a lot more sensitive to environmental factors,
  and the tubes were pressurized with an inert gas or somwthing to prevent contamination.
...
"Looks like you two were right, there is someething we were missing,"
  Dr. House said, indicating Matt and Dr. Canales.
"Can you explain exactly what you're doing to make the sigil function?"

Angela tweaked one of her ears to the side, in an expression about equivalent to furrowed one's brow.
